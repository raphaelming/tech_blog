...
//        assertThat(this.json.write(comment)).isEqualTo("/com/raphael/blog/common/comment.json");
//        assertThat(this.json.write(comment)).isEqualToJson("/com/raphael/blog/common/comment.json");
