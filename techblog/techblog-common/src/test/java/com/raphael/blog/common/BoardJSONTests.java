...
//        assertThat(this.json.write(board)).isEqualTo("/com/raphael/blog/common/board.json");
//        assertThat(this.json.write(board)).isEqualToJson("/com/raphael/blog/common/board.json");
